// METHODS - A method is a block of code which only runs when it is called. ypu can pass data known as parameters into a method. Methods are used to perform certain actions and they are also knwon as functions.
...
// METHOD OVERLOADING - When a class has tow or more methods of the same name but with different parameters then it is known as Method Overloading
